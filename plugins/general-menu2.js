...
await conn.send3ButtonImg(m.chat, await (await fetch('https://telegra.ph/file/0b5f034ce5d1c5a502f97.jpg')).buffer(),  'ʜᴇʀᴇ ᴍʏ ᴄᴏᴍᴍᴀɴᴅ ʟɪꜱᴛ', text, 'ʙᴀᴄᴋ', '.menu', 'ɪɴꜰᴏ', '.info', 'ᴀʟʟᴍᴇɴᴜ', '.pay', m, {  
      quoted: ftroli,  
      contextInfo: { //forwardingScore: 99999, isForwarded: true,  
          externalAdReply: {  showAdAttribution: true, 
              title: 'ʙᴏᴛ ᴡʜᴀᴛꜱᴀᴘᴘ ᴍᴜʟᴛɪ ᴀᴜᴛʜ',  
              body: '© ᴛɪᴏxᴅ', 
              description: 'ᴍᴀᴅᴇ ᴡɪᴛʜ ♡ ', 
              mediaType: 2,  
